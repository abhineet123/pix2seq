...
- [swin-t-640](#swin_t_64_0_)
    - [len-2       @ swin-t-640](#len_2___swin_t_640_)
        ...
        - [len-5       @ len-2/swin-t-640](#len_5___len_2_swin_t_640_)
...
<a id="len_5___len_2_swin_t_640_"></a>
### len-5       @ len-2/swin-t-640-->p2s_vid
...
CUDA_VISIBLE_DEVICES=0 python3 run.py --cfg=configs/config_det_ipsc.py --j5=eval,vid_det,m-resnet_640_mnist_640_1_12_1000_var-length-2-stride-1-batch_18,mnist-640-1-12_1000,batch-1,save-vis-1,dbg-1,dyn-1,suffix-test
...
CUDA_VISIBLE_DEVICES=0 python3 run.py --cfg=configs/config_det_ipsc.py --j5=eval,vid_det,m-resnet_640_mnist_640_5_12_1000_var-length-2-stride-1-train-batch_18,mnist-640-1-12_1000,batch-1,save-vis-1,dbg-1,dyn-1,suffix-train
<a id="on_test___len_2_mnist_640_5_12_1000_resnet_640_"></a>
#### on-test       @ len-2/mnist-640-5-12_1000/resnet-640-->p2s_vid
CUDA_VISIBLE_DEVICES=0 python3 run.py --cfg=configs/config_det_ipsc.py --j5=eval,vid_det,m-resnet_640_mnist_640_1_12_1000_var-length-2-stride-1-train-batch_18,mnist-640-1-12_1000,batch-1,save-vis-1,dbg-1,dyn-1,suffix-test
