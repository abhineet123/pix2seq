...
- [mid       @ resnet-640](#mid___resnet_640_)
    - [1k8_vid_entire_seq       @ mid](#1k8_vid_entire_seq___mi_d_)
        ...
        - [on-inv       @ 1k8_vid_entire_seq/mid](#on_inv___1k8_vid_entire_seq_mid_)
            - [vstrd-1       @ on-inv/1k8_vid_entire_seq/mid](#vstrd_1___on_inv_1k8_vid_entire_seq_mi_d_)
            - [vstrd-2       @ on-inv/1k8_vid_entire_seq/mid](#vstrd_2___on_inv_1k8_vid_entire_seq_mi_d_)
    ...
    - [10k6_vid_entire_seq       @ mid](#10k6_vid_entire_seq___mi_d_)
        ...
        - [on-inv       @ 10k6_vid_entire_seq/mid](#on_inv___10k6_vid_entire_seq_mi_d_)
            - [vstrd-1       @ on-inv/10k6_vid_entire_seq/mid](#vstrd_1___on_inv_10k6_vid_entire_seq_mid_)
            - [vstrd-2       @ on-inv/10k6_vid_entire_seq/mid](#vstrd_2___on_inv_10k6_vid_entire_seq_mid_)
...
<a id="vstrd_1___on_inv_1k8_vid_entire_seq_mi_d_"></a>
#### vstrd-1       @ on-inv/1k8_vid_entire_seq/mid-->p2s_vid-acamp
...
#### vstrd-2       @ on-inv/1k8_vid_entire_seq/mid-->p2s_vid-acamp
CUDA_VISIBLE_DEVICES=0 python3 run.py --cfg=configs/config_video_det.py  --j5=m-resnet_640_1k8_vid_entire_seq-length-2-stride-1-batch_18,_eval_,vid_det,acamp-1k8_vid_entire_seq_inv,vstrd-2,batch-3,save-vis-1,dbg-0,dyn-1
...
CUDA_VISIBLE_DEVICES=1 python3 run.py --cfg=configs/config_video_det.py  --j5=m-resnet_640_10k6_vid_entire_seq-length-2-stride-1-batch_18,_eval_,vid_det,acamp-10k6_vid_entire_seq,vstrd-1,batch-3,save-vis-1,dbg-0,dyn-1
<a id="on_inv___10k6_vid_entire_seq_mi_d_"></a>
### on-inv       @ 10k6_vid_entire_seq/mid-->p2s_vid-acamp
<a id="vstrd_1___on_inv_10k6_vid_entire_seq_mid_"></a>
#### vstrd-1       @ on-inv/10k6_vid_entire_seq/mid-->p2s_vid-acamp
CUDA_VISIBLE_DEVICES=1 python3 run.py --cfg=configs/config_video_det.py  --j5=m-resnet_640_1k8_vid_entire_seq-length-2-stride-1-batch_18,_eval_,vid_det,acamp-10k6_vid_entire_seq_inv,vstrd-1,batch-4,save-vis-1,dbg-0,dyn-1
<a id="vstrd_2___on_inv_10k6_vid_entire_seq_mid_"></a>
#### vstrd-2       @ on-inv/10k6_vid_entire_seq/mid-->p2s_vid-acamp
CUDA_VISIBLE_DEVICES=1 python3 run.py --cfg=configs/config_video_det.py  --j5=m-resnet_640_1k8_vid_entire_seq-length-2-stride-1-batch_18,_eval_,vid_det,acamp-10k6_vid_entire_seq_inv,vstrd-2,batch-4,save-vis-1,dbg-0,dyn-1
